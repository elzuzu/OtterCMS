...
import DattaSyncManager from './components/common/DattaSyncManager';
import DattaNetworkStatus from './components/common/DattaNetworkStatus';
...
export default function App() {
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <DattaSyncManager onSync={performSync}>
        <div className="datta-app">
          <div className="datta-header">
            <DattaNetworkStatus />
          </div>
